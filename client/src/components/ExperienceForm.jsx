  ...
  return (
    <div className='space-y-6'>
        <div className='flex items-center justify-between'>
          ...
          <button onClick={addExperience} className='flex items-center gap-2 px-3 py-1 text-sm bg-teal-100 text-teal-700 rounded-lg hover:bg-teal-200 transition-colors '>
        ...
        {data.length === 0?(
            <div className='text-center py-8 text-slate-500'>
                {/* when we dont have any experience data */}
                    ...
                    <div key={index} className="p-4 border border-slate-200 rounded-lg space-y-3">
                      ...
                      <div className='grid md:grid-cols-2 gap-3'>
                        ...
                        <input
                          ...
                          className="px-3 py-2 text-sm rounded-lg disabled:bg-slate-100"
                        />
                      </div>
