...
const ClassicTemplate = ({ data, accentColor }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-8 bg-white text-slate-800 leading-relaxed">
            {/* Header */}
                ...
                <section className="mb-6">
                    ...
                    <ul className="space-y-3 ">
                        {data.project.map((proj, index) => (
                            <div key={index} className="flex justify-between items-start border-l-3 border-slate-300 pl-6">
                                <div>
                                    <li className="font-semibold text-slate-800 ">{proj.name}</li>
