...
const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p>{card.name}</p>
                        <svg className="mt-0.5 fill-teal-500" width="12" height="12" viewBox="0 0 12 12"  xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-sm py-4 text-slate-800">{card.review}</p>
  ...
  return (
    ...
    <div id='testimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
        <div className="flex items-center gap-2 text-sm text-teal-600 bg-teal-400/10 border border-teal-200 rounded-full px-6 py-1.5">
            <BookUserIcon className='size-4.5 stroke-teal-600'/>
