...
export const enhanceProfessionalSummary = async (req,res) =>{
    try {
        const { userContent } = req.body // this is the content from the user side. and we will pass this to ai
        if(!userContent){
        ...
        // this will be our ai enhanced content
...
// controller for enhancing job description of a resume
...
export const uploadResume = async (req,res) =>{
    try {
        // we will first get the existing resume text that user will upload and its title from the body
        const {resumeText , title} = req.body
        const userId = req.userId  // we need this to store the data in that particular user
        ...
        // in respose we will be sending the new resume id when we will create a new resume in the db
        return res.json({
